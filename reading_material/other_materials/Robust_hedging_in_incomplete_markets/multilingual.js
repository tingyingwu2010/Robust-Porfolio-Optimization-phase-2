...
function enableMultiLingualMessages() {
  ...
  var browserLanguageIsAvaliable = AOP.avaliableLanguages.indexOf(browserLanguage) !== -1;

  if (browserLanguageIsAvaliable && AOP.uiLanguageSuggested !== 'true' && !browserLanguageIsDefault) {
